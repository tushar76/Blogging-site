...
const bodyParser = require("body-parser"); // url se data fetch krne ke liye
const ejs = require("ejs");
var _ = require('lodash') // uppercase or lowercase
...
app.use(bodyParser.urlencoded({ extended: true })); // we can fetch multiple type of data
...
const Auth = mongoose.model("Auth", validSchema) // collections
